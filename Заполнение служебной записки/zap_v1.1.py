...
transformer_type = 'ЭОДЦН-8200/10-У3'   # Тип трансформатора
...
def addition():
    excel_file = Workbook()
    ws = excel_file.create_sheet(title='Служебная записка', index=0)
    for i in filenames:
    ...
    def merge():
        ...
        # Объединить ячейки 'чертежное обозначение'
