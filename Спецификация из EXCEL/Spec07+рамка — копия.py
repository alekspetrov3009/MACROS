...
ex=Excel.Workbooks.Open(put+'\SP5.xlsm')
...
sp_obj = 0; # 0 - базовый объект, 1 - вспомогательный
while stroka1<stroka2:
    stroka1=stroka1+1
    vivod1 =listEx.Cells(stroka1,1).value   # Формат
    vivod3 =listEx.Cells(stroka1,3).value   # Позиция
                            ...
                            if vivod5=="Прочие изделия":
                                ...
                                if vivod5=="Материалы":
                                    ...
                                    if vivod5=="Комплекты":
                                        ...
                                        print (vivod1, vivod3, vivod4, vivod5,vivod6)
                                        iSpc = iDocumentSpc.GetSpecification()
                                        iSpc.ksSpcObjectCreate("", 0, ttt, 0, 0, sp_obj)
